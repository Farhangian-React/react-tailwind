...
import CardAtr from './CardAtr';
import Footer from '../../pages/Footer';
import {PageTitle} from '../../Title/PageTitle';
import AOS from "aos";
import "aos/dist/aos.css";
import "../Bag/Bag.css";
export default  function AtrA() {
    useEffect(() => {
        AOS.init({
          disable: "phone",
          duration: 700,
  ...
  return (
<>
<PageTitle title='محصولات / اکسسوری / عطر ' description=' اکسسوری ها  '/>
   <TopNavbar/> 
...
<p className="textblurb text-sm md:text-md lg:text-lg text-white text-center mt-2"> محصولات / اکسسوری / عطر</p>
</div> 
</div>
        
          <CardAtr  itemsPerPage={10}/>
          <Footer/>
   </>
   );}    
