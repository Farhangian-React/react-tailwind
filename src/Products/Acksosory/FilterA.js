...
export default  function FilterA(){
  ...
  const [checkedC13, setCheckedC13] = useState(false);
...
const handleChangeC13=(e)=>{
  setCheckedC13(e.target.checked); 
       setCheckedC13(!checkedC13);
       setDatashow([...data.filter(i=>i.color.find(j=>j.c === e.target.value))]);
       if(checkedC13){
        setDatashow([...data]);
      }
...
<FormControlLabel  control={<Checkbox checked={checked5} value={"تخفیف دار   "}  onChange={findoff} />} label="   تخفیف دار" />
  ...
  <Accordion
    ...
    sx={{borderBottom:'1px solid black',mr:1}}
  >
    <AccordionSummary  sx={{fontSize:'16px',direction:'rtl'}}  expandIcon={<IoMdAdd sx={{fontSize:'16px',pl:1.5}} />}>رنگ فریم</AccordionSummary>
    <AccordionDetails >
    <FormGroup>
    <FormControlLabel control={<Checkbox checked={checkedC1} value={"فریم قهوه ای"}  onChange={handleChangeC1} />} label="فریم قهوه ای" />
<FormControlLabel  control={<Checkbox checked={checkedC2} value={"فریم سرمه ای"}  onChange={handleChangeC2} />} label="فریم سرمه ای"/>
<FormControlLabel control={<Checkbox checked={checkedC3} value={"فریم مشکی"}  onChange={handleChangeC3} />} label="فریم مشکی" />
<FormControlLabel  control={<Checkbox checked={checkedC4} value={"فریم سفید"}  onChange={handleChangeC4} />} label=" فریم سفید" />
<FormControlLabel  control={<Checkbox checked={checkedC5} value={"فریم شفاف"}  onChange={handleChangeC5} />} label="فریم شفاف" />
<FormControlLabel control={<Checkbox checked={checkedC6} value={"فریم خاکستری"}  onChange={handleChangeC6} />} label=" فریم خاکستری" />
<FormControlLabel  control={<Checkbox checked={checkedC7} value={"فریم سبز تیره"}  onChange={handleChangeC7} />} label="فریم سبز تیره" />
<FormControlLabel  control={<Checkbox checked={checkedC8} value={"فریم طلایی"}  onChange={handleChangeC8} />} label="فریم طلایی" />
<FormControlLabel  control={<Checkbox checked={checkedC9} value={"فریم کرم"}  onChange={handleChangeC9} />} label="فریم کرم" />
</FormGroup>
    </AccordionDetails>
  </Accordion>
  <Accordion
    ...
    sx={{borderBottom:'1px solid black',mr:1}}
  >
    <AccordionSummary  sx={{fontSize:'16px',direction:'rtl'}}  expandIcon={<IoMdAdd sx={{fontSize:'16px',pl:1.5}} />}>رنگ شیشه</AccordionSummary>
    <AccordionDetails >
    <FormGroup>
    <FormControlLabel control={<Checkbox checked={checkedC10} value={"شیشه قهوه ای"}  onChange={handleChangeC10} />} label="شیشه قهوه ای" />
<FormControlLabel  control={<Checkbox checked={checkedC11} value={"شیشه سرمه ای"}  onChange={handleChangeC11} />} label="شیشه سرمه ای"/>
<FormControlLabel control={<Checkbox checked={checkedC12} value={"شیشه مشکی"}  onChange={handleChangeC12} />} label="شیشه مشکی" />
<FormControlLabel  control={<Checkbox checked={checkedC13} value={"شیشه سبز تیره"}  onChange={handleChangeC13} />} label=" شیشه سبز تیره" />
</FormGroup>
    </AccordionDetails>
  </Accordion>
</div>
