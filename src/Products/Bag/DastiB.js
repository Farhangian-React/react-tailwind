...
<p className='text-[36px] font-bold text-white text-center  '> کیف دستی</p>
<p className="text-sm text-white text-center mt-2"> محصولات/ کیف / کیف دستی</p>

</div>
</div> 
        
          <CardDastiB  itemsPerPage={10}/>
