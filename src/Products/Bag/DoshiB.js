...
<p className='textblurb text-[24px] md:text-[30px] lg:text-[36px] font-bold text-white text-center  '>  کیف دوشی</p>
<p className="textblurb text-sm md:text-md lg:text-lg text-white text-center mt-2"> محصولات / کیف دوشی</p>
</div> 
</div> 
