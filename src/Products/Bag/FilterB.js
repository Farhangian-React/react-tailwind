...
export default  function FilterB(){
  ...
  const [checkedC14, setCheckedC14] = useState(false);
  const [checkedC15, setCheckedC15] = useState(false);
  const [checkedC16, setCheckedC16] = useState(false);
...
const handleChangeC14=(e)=>{
  setCheckedC14(e.target.checked); 
       setCheckedC14(!checkedC14);
       setDatashow([...data.filter(i=>i.color.find(j=>j.c === e.target.value))]);
       if(checkedC14){
        setDatashow([...data]);
      }
...
const handleChangeC15=(e)=>{
  setCheckedC15(e.target.checked); 
       setCheckedC15(!checkedC15);
       setDatashow([...data.filter(i=>i.color.find(j=>j.c === e.target.value))]);
       if(checkedC15){
        setDatashow([...data]);
      }
}
const handleChangeC16=(e)=>{
  setCheckedC16(e.target.checked); 
       setCheckedC16(!checkedC16);
       setDatashow([...data.filter(i=>i.color.find(j=>j.c === e.target.value))]);
       if(checkedC16){
        setDatashow([...data]);
      }
...
<FormControlLabel  control={<Checkbox checked={checkedC10} value={"سبز"}      onChange={handleChangeC10} />} label="سبز" />
<FormControlLabel  control={<Checkbox checked={checkedC11} value={"نقره ای"}  onChange={handleChangeC11} />} label=" نقره ای" />
<FormControlLabel  control={<Checkbox checked={checkedC12} value={"عسلی"}     onChange={handleChangeC12} />} label=" عسلی" />
<FormControlLabel  control={<Checkbox checked={checkedC13} value={"بژ"}       onChange={handleChangeC13} />} label="بژ" />
<FormControlLabel  control={<Checkbox checked={checkedC14} value={"قرمز"}     onChange={handleChangeC14} />} label="قرمز" />
<FormControlLabel  control={<Checkbox checked={checkedC15} value={"زرد"}      onChange={handleChangeC15} />} label="زرد" />
<FormControlLabel  control={<Checkbox checked={checkedC16} value={"بنفش"}     onChange={handleChangeC16} />} label="بنفش" />
</FormGroup>
      </AccordionDetails>
    </Accordion>
</div>
