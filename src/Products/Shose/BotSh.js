...
<p className='textblursh text-[26px] md:text-[30px] font-bold text-white text-center  '>   نیم بوت</p>
<p className="textblursh text-sm text-white text-center mt-2"> محصولات/ کفش /  نیم بوت</p>
</div> 
</div> 
