...
<p className='textblursh text-[26px] md:text-[30px] lg:text-[36px] font-bold text-white text-center  '>  کفش صندل</p>
<p className="textblursh text-sm md:text-md lg:text-lg text-white text-center mt-2"> محصولات/ کفش / کفش صندل</p>
</div> 
</div>
