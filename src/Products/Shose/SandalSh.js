...
<p className='textblursh text-[26px] md:text-[30px] font-bold text-white text-center  '>  کفش صندل</p>
<p className="textblursh text-sm text-white text-center mt-2"> محصولات/ کفش / کفش صندل</p>
</div> 
</div>
