      ...
      <div className="inline sm:hidden mx-2 py-5 w-[95%]   px-2 h-[400px] mt-20  ">
        <Slide  slidesToScroll={1} slidesToShow={1} indicators={false}   >
         {data.map((item)=> (
          ...
          onClick={()=>{
            setCartItems([item]);
           }} key={item.id} className='flex justify-center items-center mx-auto px-0 backdrop-blur-lg rounded-3xl py-5 '>
            <div  className='bg-transparent relative w-[95%] h-[380px]  rounded-lg shadow-xl
             transition delay-150 duration-300 ease-in-out hover:h-[485px] overflow-hidden 
             bg-white' >
...
<div 
                 ...
                 <div dir="rtl" className='relative top-[-40px] z-10 pt-9 pb-2 px-5 transition delay-150 duration-300 ease-in-out'>
                   <p className='text-sm text-start text-gray-800 font-bold pb-7'> {item.title1}</p> 
                   <Rating
...
:<p className='text-lg text-start text-indigo-800 font-bold  '>{item.price}</p>}
      ...
      <div className="hidden lg:inline xl:hidden mx-10 py-5  w-5/8 px-5 h-[410px]  mt-10 ">
...
:<p className='text-lg text-start text-indigo-800 font-bold  '>{item.price}</p>}
      ...
      <div className="hidden xl:inline mx-10 py-5  w-5/8 px-5 h-[410px] bg-transparent  mt-10">
