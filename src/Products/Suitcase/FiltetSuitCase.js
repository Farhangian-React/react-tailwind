...
<FormControlLabel  control={<Checkbox checked={checked2} value={"تخفیف دار   "}  onChange={sortArrayMintoMax} />} label="   تخفیف دار" />
    ...
    >
      ...
      <AccordionDetails >
      <FormGroup>
<FormControlLabel control={<Checkbox checked={checked1} value={"طلایی"}  onChange={sortArrayMaxtoMin} />} label="طلایی" />
<FormControlLabel  control={<Checkbox checked={checked2} value={"آبی پاستیلی"}  onChange={sortArrayMintoMax} />} label="آبی پاستیلی"/>
<FormControlLabel control={<Checkbox checked={checked1} value={"مشکی"}  onChange={sortArrayMaxtoMin} />} label="مشکی" />
<FormControlLabel  control={<Checkbox checked={checked2} value={"صورتی"}  onChange={sortArrayMintoMax} />} label="صورتی" />
<FormControlLabel  control={<Checkbox checked={checked2} value={"آبی"}  onChange={sortArrayMintoMax} />} label="آبی" />
<FormControlLabel control={<Checkbox checked={checked1} value={"فیروزه ای"}  onChange={sortArrayMaxtoMin} />} label="فیروزه ای" />
<FormControlLabel  control={<Checkbox checked={checked2} value={"آبی روشن"}  onChange={sortArrayMintoMax} />} label="آبی روشن" />
...
<FormControlLabel  control={<Checkbox checked={checked2} value={"زرد"}  onChange={sortArrayMintoMax} />} label="زرد" />
<FormControlLabel  control={<Checkbox checked={checked2} value={"مرجانی"}  onChange={sortArrayMintoMax} />} label="مرجانی" />
</FormGroup>
      </AccordionDetails>
    </Accordion>
    <Accordion
    ...
    >
      ...
      <AccordionDetails >
      <FormGroup>
<FormControlLabel control={<Checkbox checked={checked1} value={"تک سایز  "}  onChange={sortArrayMaxtoMin} />} label="تک سایز  " />
<FormControlLabel  control={<Checkbox checked={checked2} value={" در سه سایز"}  onChange={sortArrayMintoMax} />} label=" در سه سایز"/>
</FormGroup>
      </AccordionDetails>
    </Accordion>
</div>
...
<div className='w-[98%] self-center flex flex-col justify-center lg:hidden'>
<Accordion
      expanded={index === 0}
      onChange={(event, expanded) => {
        setIndex(expanded ? 0 : null);
